...
const improvinPlugin = await import('eslint-plugin-improvin');
...
export default [
    ...
    ...compat.extends('airbnb', 'airbnb-typescript', 'airbnb/hooks', 'plugin:@typescript-eslint/recommended', 'plugin:prettier/recommended'),
    {
        plugins: {
            improvin: improvinPlugin.default,
        ...
        rules: {
            ...
            'no-restricted-syntax': [
                ...
                // i.e. `() => {}` instead of `function() {}`.
                {
                    ...
                    message: 'Use `const` with arrow functions instead of `function` declarations.',
                },
                ...
                // or `const foo = () => {}; export default foo;` at the end of the file.
                {
                    ...
                    message: 'Inline exports are not allowed. Export separately at the end of the file.',
                },
                {
